...
class Homecontentlandlord extends StatefulWidget {
  const Homecontentlandlord({super.key});

  @override
  State<Homecontentlandlord> createState() => _Homecontentlandlord();
}

class _Homecontentlandlord extends State<Homecontentlandlord> {
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.pushNamed(context, '/paymentanalysis');
                },
                child: Container(
                  child: Container(
                    width: 800,
                    ...
                    child: const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10),
                          Text("Your payment analysis here."),
                        ],
                      ),
                    ),
                  ),
                ...
                child: Container(
                  ...
                  child: const Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10),
                      Text("Your properites info will be displayed here."),
                    ],
                  ),
                ),
              ),
